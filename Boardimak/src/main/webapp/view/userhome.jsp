                ...
                <div class="row">
                    <div class="left-panel">
                        ...
                        <div class="wrapper-menu">
                                <ul>
                                    ...
                                    <a href="/show-user"> <li class="active"><img src="assets/icons/users-icon.png" alt="Users Icon">Users</li></a>
                                    ...
                                    <a href="/cmsHome"><li><img src="assets/icons/content-management-icon.png" alt="Contemtn Management Icon">Content Management</li></a>
                    ...
                    <div class="right-panel">
                        <div class="wrapper-body">
                            <h3>All Users</h3>
                            <button class="btn-blue btn-add-pro">
								<a href="/new-users">+Add User</a>
							</button>
                        ...
                        <div class="dashboard-body">
								...
								<c:forEach var="u" items="${user}">
                                    <tr>
										...
										<td><p>${u.email}</p></td>
									    <td><p>${u.address1}</p></td>
										<td><p>${u.address2}</p></td>
										<td><p>${u.phone_num}</p></td>
                                 
								
									
                                        <td>
                                            <ul class="list-actions">
                                                <a href="/edit-users?id=${u.id}"><li><img src="assets/icons/home-060-edit-512.png" width="20px" height="20px" alt="Edit user icon "></li></a>
											
                                                <a href="/delete-users?id=${u.id}"><li><img src="assets/icons/delete-icon.png" alt="Delete user icon"></li></a>
                                            </ul>
                                        </td>
                                    </tr>
                                    </c:forEach>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="form-group row">
                                    <h6 class="col-form-label col-sm-8">Select Property:</h6>
